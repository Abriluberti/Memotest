...
export class HerramientasPage implements OnInit {
  ...
  selectedCards: Card[] = [];
  animalImages: string[] = [
    'assets/herramientas/herramientas uno.jpg',
    'assets/herramientas/herramientas dos.jpg',
    'assets/herramientas/herramientas tres.jpg',
    'assets/herramientas/herramientas cuatro.jpg',
    'assets/herramientas/herramientas cinco.jpg',
  ...
  async guardarTiempoEnFirestore(tiempo: number) {
    ...
    try {
      const referencia = collection(this.firestore, 'registrosDeTiempoHerramientas'); // Reemplaza 'registrosDeTiempo' con el nombre de tu colección en Firestore
      const tiempoData = {
